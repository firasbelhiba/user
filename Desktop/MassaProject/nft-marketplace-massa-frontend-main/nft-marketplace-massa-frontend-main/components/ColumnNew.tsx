...
export default class Responsive extends Component<{}, ResponsiveState> {
    dummyData: NftData[];
    ...
    onImgLoad = ({ target: img }: React.SyntheticEvent<HTMLImageElement>) => {
        let currentHeight = this.state.height;
        if (currentHeight < (img as HTMLImageElement).offsetHeight) {
            this.setState({
